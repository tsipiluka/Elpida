package live.wh0cares.elpida.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, live.wh0cares.elpida.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, live.wh0cares.elpida.repository.UserRepository.USERS_BY_EMAIL_CACHE);
