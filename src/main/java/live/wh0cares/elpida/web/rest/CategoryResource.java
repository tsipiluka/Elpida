...
import live.wh0cares.elpida.domain.Category;
import live.wh0cares.elpida.repository.CategoryRepository;
...
/**
 * REST controller for managing {@link live.wh0cares.elpida.domain.Category}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Category> result = categoryRepository
            ...
            .map(existingCategory -> {
                ...
                if (category.getLimit() != null) {
                    existingCategory.setLimit(category.getLimit());
                }
