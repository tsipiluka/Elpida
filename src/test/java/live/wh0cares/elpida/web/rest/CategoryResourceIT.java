...
class CategoryResourceIT {
    ...
    public static Category createEntity(EntityManager em) {
        Category category = new Category().iD(DEFAULT_I_D).name(DEFAULT_NAME).limit(DEFAULT_LIMIT);
        return category;
    }
    ...
    public static Category createUpdatedEntity(EntityManager em) {
        Category category = new Category().iD(UPDATED_I_D).name(UPDATED_NAME).limit(UPDATED_LIMIT);
        return category;
    }
    ...
    void createCategory() throws Exception {
        ...
        assertThat(testCategory.getiD()).isEqualTo(DEFAULT_I_D);
        assertThat(testCategory.getName()).isEqualTo(DEFAULT_NAME);
        assertThat(testCategory.getLimit()).isEqualTo(DEFAULT_LIMIT);
    }
    ...
    void putNewCategory() throws Exception {
        ...
        updatedCategory.iD(UPDATED_I_D).name(UPDATED_NAME).limit(UPDATED_LIMIT);
        ...
        Category testCategory = categoryList.get(categoryList.size() - 1);
        assertThat(testCategory.getiD()).isEqualTo(UPDATED_I_D);
        assertThat(testCategory.getName()).isEqualTo(UPDATED_NAME);
        assertThat(testCategory.getLimit()).isEqualTo(UPDATED_LIMIT);
    }
    ...
    void partialUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.iD(UPDATED_I_D);
    ...
    void fullUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.iD(UPDATED_I_D).name(UPDATED_NAME).limit(UPDATED_LIMIT);
